...
#URL_TEST = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSBbmAcIU9L8RqR0c4UhIzvPNxb04vNVj0MQw&usqp=CAU'
#URL_TEST = ''
...
def main():
    ...
    test_model_on_selected_photo(URL_TEST, model, out_encoder)
